...
export function printScanResult(result: ScanResult, verbose: boolean = false): void {
  ...
  // Group by type
  const grouped = new Map<string, CruftItem[]>();
...
export function printCleanResult(freedSpace: number, deletedCount: number): void {
  console.log();
...
export function printDryRunResult(result: ScanResult): void {
  console.log();
...
export function lobsterMessage(message: string): string {
